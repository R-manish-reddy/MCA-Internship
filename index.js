...
const productsPutRoute = require('./routes/productsPut');
const productsDeleteRoute = require('./routes/productsDelete');
const productsQueryRoute = require('./routes/ProductQuery');
...
app.use('/api/products', productsPutRoute);
app.use('/api/products', productsDeleteRoute);

app.use('/api/products', productsQueryRoute);
