...
CREATE TABLE `productlikes` (
  ...
  CONSTRAINT `productlikes_ibfk_2` FOREIGN KEY (`product_id`) REFERENCES `product` (`product_id`) ON DELETE CASCADE
...
INSERT INTO `productlikes` VALUES (1,10),(2,5),(3,20),(4,8),(5,15),(6,12),(7,3),(8,18),(9,7),(11,9),(12,14),(13,6);
